                                ...
                                <div class="ml-3 relative">
                                    <jet-dropdown align="right" width="48">
                                        ...
                                        <template #content>
                                            ...
                                            <jet-dropdown-link :href="route('booking.index')">
                                                Liste des réservations
                                            </jet-dropdown-link>

                                            <jet-dropdown-link :href="route('client.index')">
                                                Liste des clients
                                            </jet-dropdown-link>

                                            <jet-dropdown-link :href="route('material.index')">
                                                Liste du materiel
                                            </jet-dropdown-link>

                                            <jet-dropdown-link :href="route('room.index')">
                                                Liste des salles
                                            </jet-dropdown-link>
                                        </template>
                                    </jet-dropdown>
